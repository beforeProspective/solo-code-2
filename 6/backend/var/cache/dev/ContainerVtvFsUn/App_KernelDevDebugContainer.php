...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\AdapterController' => 'getAdapterControllerService',
            'App\\Controller\\LensController' => 'getLensControllerService',
            'App\\Controller\\MaintenanceRecordController' => 'getMaintenanceRecordControllerService',
            'App\\Controller\\SamplePhotoController' => 'getSamplePhotoControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventListener'.\DIRECTORY_SEPARATOR.'CorsListener.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventListener\\CorsListener')] fn () => ($container->privates['App\\EventListener\\CorsListener'] ??= new \App\EventListener\CorsListener()), 'onKernelRequest'], 9999);
        $instance->addListener('kernel.response', [#[\Closure(name: 'App\\EventListener\\CorsListener')] fn () => ($container->privates['App\\EventListener\\CorsListener'] ??= new \App\EventListener\CorsListener()), 'onKernelResponse'], 9999);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        return $container->services['http_kernel'] = new \Symfony\Component\HttpKernel\HttpKernel(($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container)), new \Symfony\Component\HttpKernel\Controller\TraceableControllerResolver(new \Symfony\Bundle\FrameworkBundle\Controller\ControllerResolver($container, ($container->privates['logger'] ?? self::getLoggerService($container))), $a), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Component\HttpKernel\Controller\TraceableArgumentResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(($container->privates['argument_metadata_factory'] ??= new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory()), new RewindableGenerator(function () use ($container) {
            ...
            'argument_resolver.backed_enum_resolver' => ['privates', '.debug.value_resolver.argument_resolver.backed_enum_resolver', 'get_Debug_ValueResolver_ArgumentResolver_BackedEnumResolverService', true],
            'argument_resolver.datetime' => ['privates', '.debug.value_resolver.argument_resolver.datetime', 'get_Debug_ValueResolver_ArgumentResolver_DatetimeService', true],
    ...
    {
        return $container->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('f5ANl4k8+n', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
